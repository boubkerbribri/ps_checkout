...
class OrderStates
{
    ...
    const PS_CHECKOUT_STATE_WAITING_CAPTURE = 'WAITING_CAPTURE';
    const PS_CHECKOUT_STATE_AUTHORIZED = 'AUTHORIZED';
    const PS_CHECKOUT_STATE_CAPTURED = 'CAPTURED';
    const PS_CHECKOUT_STATE_VOIDED = 'VOIDED';
    const PS_CHECKOUT_STATE_REFUNDED = 'REFUNDED';
    const PS_CHECKOUT_STATE_PARTIALLY_REFUNDED = 'PARTIALLY_REFUNDED';
    const ORDER_STATES = [
