...
{
    /**
     * Updates the PsCheckout Session
     *
     ...
     * @return bool
     */
    public static function updateSession($psCheckoutCartRepository, $cartId, $bodyValues)
    {
        $psCheckoutCart = $psCheckoutCartRepository->findOneByCartId((int) $cartId);
        if (false !== $psCheckoutCart) {
            ...
            return $psCheckoutCartRepository->save($psCheckoutCart);
        }
